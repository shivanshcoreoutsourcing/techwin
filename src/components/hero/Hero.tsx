                            ...
                            <div className="absolute inset-0 flex items-center">
                                <div className="mx-auto max-w-6xl w-full px-6 md:px-10 lg:px-16">
                                    <div className="max-w-2xl text-white">
                                        {/* animated headline */}
                                        <h1
                                            className={`text-2xl md:text-4xl lg:text-5xl font-semibold leading-tight drop-shadow-md transform transition-all duration-700 ${active ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
                                                }`}
                                        ...
                                        <div className={`mt-6 flex gap-3 flex-wrap ${active ? "opacity-100" : "opacity-0"} transition-opacity duration-700`} style={{ transitionDelay: active ? "320ms" : "0ms" }}>
                                            {s.ctaPrimary ? (
                                                <Link
                                                    ...
                                                    className="inline-block rounded-full bg-[#3B9ACB] text-white px-5 py-2.5 font-medium shadow-lg hover:shadow-xl transition transform hover:-translate-y-0.5"
                                                >
                                                    {s.ctaPrimary.label}
                                                </Link>
                                            ) : null}
                                            ...
                                            {s.ctaSecondary ? (
                                                <Link
                                                    ...
                                                    className="inline-block rounded-full border border-white/30 text-white px-4 py-2 font-medium hover:bg-white/10 transition"
                                                >
            ...
            {length > 1 && (
                <>
                    <button
                        ...
                        className="absolute left-4 top-1/2 -translate-y-1/2 z-40 rounded-full bg-linear-to-br from-white/95 to-white/80 p-3 shadow-lg hover:scale-105 transition-transform cursor-pointer"
                    >
                    ...
                    <button
                        ...
                        onClick={() => goTo(index + 1)}
                        className="absolute right-4 top-1/2 -translate-y-1/2 z-40 rounded-full bg-linear-to-br from-white/95 to-white/80 p-3 shadow-lg hover:scale-105 transition-transform cursor-pointer"
                    >
